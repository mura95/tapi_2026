...
public class LyingAnimator : StateMachineBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    private AudioClip DogSounds102;
    [SerializeField]
    private AudioClip DogSounds_yawn;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (_isBored == false)
        {
            ...
            if (_idleTime > _timeUntilBored && stateInfo.normalizedTime % 1 < 0.02f)
            {
                ...
                animator.SetFloat("LyingAnimation", _boredAnimation - 1);
            }
        ...
        animator.SetFloat("LyingAnimation", _boredAnimation, 0.2f, Time.deltaTime);
        if (Mathf.Abs(animator.GetFloat("LyingAnimation") - _boredAnimation) < 0.01f)
        {
            animator.SetFloat("LyingAnimation", _boredAnimation);
        }
    }
